...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_votes:
        ...
        county_votes = counties_votes[county_name]
        ...
        county_result = f"{county_name}: {county_vote_percentage:.1f}% ({county_votes:,})\n"
        print(county_result)
        ...
        if (county_votes > winning_turnout) and (county_vote_percentage > county_winning_percentage):
